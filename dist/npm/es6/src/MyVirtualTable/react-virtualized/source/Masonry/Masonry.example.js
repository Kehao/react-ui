...
function (_React$PureComponent) {
  ...
  function GridExample(props, context) {
    ...
    _this._resetList = function () {
      ...
      return (_this2 = _this).___resetList__REACT_HOT_LOADER__.apply(_this2, arguments);
    };
  ...
  _createClass(GridExample, [{
    key: "___resetList__REACT_HOT_LOADER__",
    value: function ___resetList__REACT_HOT_LOADER__() {
      return this.___resetList__REACT_HOT_LOADER__.apply(this, arguments);
    }
  }, {
    key: "render",
      ...
      return React.createElement(ContentBox, null, React.createElement(ContentBoxHeader, {
        ...
        onChange: function onChange(event) {
          ...
          _this3.setState({
            ...
            _this3._calculateColumnCount();

            _this3._resetCellPositioner();

            _this3._masonry.clearCellPositions();
          });
        },
        value: columnWidth
      }), React.createElement(LabeledInput, {
        ...
        onChange: function onChange(event) {
          _this3.setState({
            ...
            _this3._masonry.recomputeCellPositions();
          });
        },
        value: gutterSize
      }), React.createElement(LabeledInput, {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(GridExample, "GridExample", "/Users/qiu/biosan/BiosanUi/src/MyVirtualTable/react-virtualized/source/Masonry/Masonry.example.js");
}();
