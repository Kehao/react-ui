...
var Print = function Print(options) {
  ...
  printWindow.onload = function () {
    ...
    var srcCanvasEls = _toConsumableArray(contentNodes.querySelectorAll('canvas'));
    ...
    _toConsumableArray(canvasEls).forEach(function (node, index) {
    ...
    if (copyStyles !== false) {
      ...
      _toConsumableArray(headEls).forEach(function (node, index) {
        if (node.tagName === 'STYLE') {
          ...
          var attributes = _toConsumableArray(node.attributes);
