...
function (_React$Component) {
  ...
  function ViewPic(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ViewPic).call(this, props));
  ...
  _createClass(ViewPic, [{
    ...
    value: function __getBigCalList__REACT_HOT_LOADER__() {
      ...
      var bigList = fileList.map(function (file, i) {
        ...
        }, /.pdf|.PDF/.test(file.file_name) ? React.createElement("embed", {
          id: "bigImg".concat(i),
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        effect: "fade"
      }, bigList), picHover ? [React.createElement(_Icon, {
        type: "left",
        key: "1",
        className: 'anticon',
        style: {
      ...
      }, isFold ? React.createElement(_Icon, {
        type: "up-circle"
      }) : React.createElement(_Icon, {
        type: "down-circle"
      }), "\u56FE\u7247\u5217\u8868"), "|", React.createElement("span", {
        className: 'size'
      }, React.createElement("span", {
        className: 'icon'.concat(" ", 'icon_left'),
        onClick: this.imgToSize.bind(this, 0.2)
      }, "+"), parseInt(scale * 100, 10), "%", React.createElement("span", {
        ...
        ref: "carouselSmall",
        dots: false
      }, this.getSmallCalList()), React.createElement("span", {
        className: 'span_left'
      }, React.createElement(_Icon, {
        type: "left",
        onClick: function onClick() {
