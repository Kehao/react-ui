...
describe('InfiniteLoader', function () {
  ...
  it('should :forceUpdate once rows have loaded if :loadMoreRows returns a Promise',
  /*#__PURE__*/
  function () {
  ...
  it('should not :forceUpdate once rows have loaded rows are no longer visible',
  /*#__PURE__*/
  function () {
  ...
  it('should call :recomputeGridSize if defined', function () {
    ...
    function (_React$Component) {
      ...
      function TestComponent() {
        ...
        _this.recomputeGridSize = recomputeGridSize;
        return _this;
      }
  ...
  it('should called :recomputeRowHeights if defined', function () {
    ...
    function (_React$Component2) {
      ...
      function TestComponent() {
        ...
        _this2.recomputeRowHeights = recomputeRowHeights;
        return _this2;
      }
  ...
  it('should call :forceUpdate otherwise', function () {
    ...
    function (_React$Component3) {
      ...
      function TestComponent() {
        ...
        _this3.forceUpdate = forceUpdate;
        return _this3;
      }
