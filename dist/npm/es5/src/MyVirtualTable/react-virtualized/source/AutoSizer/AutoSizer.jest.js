...
describe('AutoSizer', function () {
  ...
  it('should update :height after a resize event',
  /*#__PURE__*/
  function () {
  ...
  describe('onResize and (re)render', function () {
    it('should trigger when size changes',
    /*#__PURE__*/
    function () {
    ...
    it('should only trigger when height changes for disableWidth == true',
    /*#__PURE__*/
    function () {
    ...
    it('should only trigger when width changes for disableHeight == true',
    /*#__PURE__*/
    function () {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(DefaultChildComponent, "DefaultChildComponent", "/Users/qiu/biosan/BiosanUi/src/MyVirtualTable/react-virtualized/source/AutoSizer/AutoSizer.jest.js");
}();
