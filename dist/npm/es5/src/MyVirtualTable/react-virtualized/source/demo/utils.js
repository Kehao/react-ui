...
exports.generateRandomList = generateRandomList;
...
function generateRandomList() {
  ...
  for (var i = 0; i < 1000; i++) {
    var random = loremIpsum[i % loremIpsum.length];
    var randoms = [random];

    for (var j = Math.round(Math.random() * 10); j--;) {
...
var BADGE_COLORS = ['#f44336', '#3f51b5', '#4caf50', '#ff9800', '#2196f3', '#374046', '#cddc39', '#2196f3', '#9c27b0', '#ffc107', '#009688', '#673ab7', '#ffeb3b', '#cddc39', '#795548'];
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(generateRandomList, "generateRandomList", "/Users/qiu/biosan/BiosanUi/src/MyVirtualTable/react-virtualized/source/demo/utils.js");

  __REACT_HOT_LOADER__.register(BADGE_COLORS, "BADGE_COLORS", "/Users/qiu/biosan/BiosanUi/src/MyVirtualTable/react-virtualized/source/demo/utils.js");

  __REACT_HOT_LOADER__.register(NAMES, "NAMES", "/Users/qiu/biosan/BiosanUi/src/MyVirtualTable/react-virtualized/source/demo/utils.js");

  __REACT_HOT_LOADER__.register(ROW_HEIGHTS, "ROW_HEIGHTS", "/Users/qiu/biosan/BiosanUi/src/MyVirtualTable/react-virtualized/source/demo/utils.js");

  __REACT_HOT_LOADER__.register(loremIpsum, "loremIpsum", "/Users/qiu/biosan/BiosanUi/src/MyVirtualTable/react-virtualized/source/demo/utils.js");
}();
