...
var encrypt = function encrypt(value, key) {
  ...
  try {
    ...
    var pubKey = new _nodeRsa.default(handleKeyFun(key, outputFormat, 'PUBLIC'));
    pubKey.setOptions({
      encryptionScheme: encryptedFormat
    });
...
var decrypt = function decrypt(value, privateKey) {
  ...
  try {
    ...
    var keyString = new _nodeRsa.default(handleKeyFun(privateKey, outputFormat, 'PRIVATE'));
